...
if(!function_exists('_geoip_seek_country_v6')) {
	function _geoip_seek_country_v6($gi, $ipnum) {
		...
		throw new Exception('Error traversing database. File may be corrupt, please try replacing it with a new one. You can download it from MaxMind website.');
		return false;
	}
}
